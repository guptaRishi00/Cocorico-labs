...
import { 
  ...
  Rocket, Code2, Gem, 
  Globe2, CheckCircle2, Plus, Minus, FileText, BadgeCheck, TrendingUp,
  Scale, Briefcase, Shield, Landmark, Users
} from 'lucide-react';

/* 🏆 COCORICOLABS - CORRECTIF NAVBAR
  --------------------------------------------------
  Correctifs : Suppression du mix-blend-mode pour éviter les chevauchements visuels.
  Amélioration : Fond plus opaque au scroll et gestion z-index.
*/
        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 mb-20 md:mb-32">
           <div>
              ...
              <p className="text-lg md:text-xl text-slate-400 max-w-md mb-8 md:mb-12">
                 Obtenez un devis détaillé pour votre projet Web3 ou un audit juridique dès aujourd’hui.
              </p>
              <a href="mailto:hello@cocoricolabs.com" className="text-2xl md:text-5xl font-bold hover:text-blue-500 transition-colors underline decoration-slate-700 underline-offset-8 break-all md:break-normal">
              ...
              <div className="grid grid-cols-2 gap-8 md:gap-12">
                 ...
                 <div>
                    ...
                    <ul className="space-y-3 md:space-y-4 text-base md:text-lg cursor-pointer">
                       ...
                       <li onClick={() => setPage('legal')} className="hover:text-red-500 transition-colors">Juridique</li>
                       ...
                       <li onClick={() => setPage('faq')} className="hover:text-red-500 transition-colors">FAQ</li>
                    </ul>
                 </div>
              </div>
           </div>
    ...
    <section className="relative min-h-[90vh] md:min-h-screen pt-28 md:pt-32 pb-16 md:pb-20 px-6 md:px-12 flex flex-col justify-center overflow-hidden">
      ...
      <div className="max-w-[1600px] mx-auto w-full relative">
        <div className="mb-6 md:mb-8 flex items-center gap-4 reveal-up" style={{ animationDelay: '0.1s' }}>
           ...
           <span className="text-xs md:text-sm font-bold uppercase tracking-[0.2em] text-blue-700">Expertise Innovation</span>
        </div>
        ...
        <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-end reveal-up" style={{ animationDelay: '0.4s' }}>
           <div className="md:col-span-5">
             <p className="text-lg md:text-2xl font-light leading-relaxed text-slate-600 mb-6 md:mb-8">
               Nous développons des <strong>MVPs et solutions Web3</strong> pour des entreprises en phase de R&D, avec une documentation technique conforme aux standards français.
             </p>
                 ...
                 <div className="relative w-full h-full bg-white border border-slate-200 shadow-2xl transition-transform duration-700 transform md:group-hover:rotate-y-12 md:group-hover:rotate-x-6 preserve-3d">
                    <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-between overflow-hidden">
                      ...
                      <div className="mt-auto">
                        ...
                        <p className="text-xs md:text-sm text-slate-500 font-mono border-t border-slate-100 pt-2">MAXIMISEZ VOTRE RUNWAY</p>
                      </div>
  ...
  <div className="min-h-screen pt-28 md:pt-32 px-6 md:px-12 animate-in slide-in-from-bottom-8 duration-700">
    <div className="max-w-[1600px] mx-auto">
      <div className="mb-12 md:mb-20">
        <h1 className="text-5xl md:text-9xl font-bold mb-4 md:mb-8">Projets <br/><span className="font-serif italic text-blue-600">Réalisés</span></h1>
        <p className="text-lg md:text-xl text-slate-500 max-w-2xl">
          Sites sur mesure, MVPs et solutions Blockchain pour les entreprises innovantes.
        </p>
      </div>

      <div className="grid md:grid-cols-2 gap-8 md:gap-12 mb-20 md:mb-32">
        {[
          { title: "Marketplace NFT", cat: "Web3 / Blockchain", color: "bg-emerald-100", year: "2024" },
          { title: "SaaS R&D", cat: "Outil Interne", color: "bg-slate-900", year: "2023", dark: true },
          { title: "E-Commerce Luxe", cat: "Site Sur Mesure", color: "bg-slate-100", year: "2024" },
          { title: "Fintech MVP", cat: "App Bancaire", color: "bg-blue-600", year: "2023", dark: true }
        ].map((project, i) => (
...
const Legal = () => (
  <div className="min-h-screen pt-28 md:pt-32 px-6 md:px-12 animate-in slide-in-from-bottom-8 duration-700 bg-[#FDFBF7]">
    <div className="max-w-[1400px] mx-auto">
      
      {/* Hero Juridique */}
      <div className="mb-24">
        <div className="inline-flex items-center gap-3 px-4 py-2 border border-slate-900 rounded-full mb-8">
          <Scale size={16} />
          <span className="text-xs font-bold uppercase tracking-widest">Pôle Conseil</span>
        </div>
        <h1 className="text-5xl md:text-8xl font-bold mb-12 leading-tight">
          Où la stratégie rencontre <br/> <span className="text-blue-600 font-serif italic">le droit</span>.
        </h1>
        <div className="grid md:grid-cols-2 gap-12">
          <p className="text-xl text-slate-600 leading-relaxed font-light border-l-4 border-red-500 pl-6">
            "Chez Cocorico Labs, nous ne vous disons pas seulement ce qui est interdit. Nous vous montrons comment le droit peut vous donner un avantage décisif."
          </p>
          <div className="space-y-4">
            <p className="text-slate-500">
              Notre approche unique consiste à intégrer l'expertise juridique au cœur de la réflexion stratégique. 
              Nous transformons l'adaptation réglementaire en avantage concurrentiel et sécurisons votre croissance.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-32">
        <div className="bg-white p-10 border border-slate-200 hover:border-blue-600 transition-colors duration-300 group">
          <TrendingUp size={40} className="text-slate-400 mb-6 group-hover:text-blue-600 transition-colors" />
          <h3 className="text-2xl font-bold mb-4">Stratégies de Croissance (M&A)</h3>
          <ul className="space-y-3 text-slate-500 text-sm">
            <li className="flex gap-2"><div className="w-1 h-1 bg-red-500 mt-2"></div>Due diligence juridique risques & opportunités.</li>
            <li className="flex gap-2"><div className="w-1 h-1 bg-red-500 mt-2"></div>Structuration d'opérations complexes (JV, fusions).</li>
            <li className="flex gap-2"><div className="w-1 h-1 bg-red-500 mt-2"></div>Négociation de pactes d'actionnaires.</li>
          </ul>
        </div>

        <div className="bg-white p-10 border border-slate-200 hover:border-blue-600 transition-colors duration-300 group">
          <Landmark size={40} className="text-slate-400 mb-6 group-hover:text-blue-600 transition-colors" />
          <h3 className="text-2xl font-bold mb-4">Gouvernance & Structure</h3>
          <ul className="space-y-3 text-slate-500 text-sm">
            <li className="flex gap-2"><div className="w-1 h-1 bg-red-500 mt-2"></div>Optimisation fiscale et holding.</li>
            <li className="flex gap-2"><div className="w-1 h-1 bg-red-500 mt-2"></div>Audit des chartes de gouvernance.</li>
            <li className="flex gap-2"><div className="w-1 h-1 bg-red-500 mt-2"></div>Protection du patrimoine.</li>
          </ul>
        </div>

        <div className="bg-white p-10 border border-slate-200 hover:border-blue-600 transition-colors duration-300 group">
          <Briefcase size={40} className="text-slate-400 mb-6 group-hover:text-blue-600 transition-colors" />
          <h3 className="text-2xl font-bold mb-4">Stratégie Commerciale</h3>
          <ul className="space-y-3 text-slate-500 text-sm">
            <li className="flex gap-2"><div className="w-1 h-1 bg-red-500 mt-2"></div>Droit de la concurrence & antitrust.</li>
            <li className="flex gap-2"><div className="w-1 h-1 bg-red-500 mt-2"></div>Négociation de contrats stratégiques.</li>
            <li className="flex gap-2"><div className="w-1 h-1 bg-red-500 mt-2"></div>Sécurisation des revenus critiques.</li>
          </ul>
        </div>

        <div className="bg-white p-10 border border-slate-200 hover:border-blue-600 transition-colors duration-300 group">
          <Shield size={40} className="text-slate-400 mb-6 group-hover:text-blue-600 transition-colors" />
          <h3 className="text-2xl font-bold mb-4">Compliance & Risques</h3>
          <ul className="space-y-3 text-slate-500 text-sm">
            <li className="flex gap-2"><div className="w-1 h-1 bg-red-500 mt-2"></div>Cartographie des risques (RGPD, social).</li>
            <li className="flex gap-2"><div className="w-1 h-1 bg-red-500 mt-2"></div>Programmes de conformité sur-mesure.</li>
            <li className="flex gap-2"><div className="w-1 h-1 bg-red-500 mt-2"></div>Protection de la réputation.</li>
          </ul>
        </div>
      </div>

      {/* Methodology */}
      <div className="bg-slate-900 text-white p-8 md:p-20 rounded-3xl mb-32">
        <h2 className="text-4xl md:text-5xl font-bold mb-16 text-center">L'Approche Cocorico</h2>
        <div className="grid md:grid-cols-4 gap-8">
          {[
            { step: "01", title: "Diagnostic Intégré", text: "Analyse stratégique, opérationnelle ET juridique simultanée." },
            { step: "02", title: "Langage Business", text: "Traduction de la complexité juridique en impact financier clair." },
            { step: "03", title: "Équipe Intégrée", text: "Avocats, stratèges et financiers travaillant main dans la main." },
            { step: "04", title: "Livrables Ops", text: "Pas de mémos théoriques. Des plans d'actions et roadmaps." }
          ].map((m, i) => (
            <div key={i} className="relative pt-8 border-t border-white/20">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-600 to-transparent transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></div>
              <div className="text-4xl font-serif italic text-blue-500 mb-4">{m.step}</div>
              <h4 className="text-xl font-bold mb-3">{m.title}</h4>
              <p className="text-slate-400 text-sm leading-relaxed">{m.text}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
        <div>
          ...
          <div className="space-y-6">
            {[
              { t: "Vision Holistique", d: "Connexion entre droit, finance et stratégie." },
              { t: "Approche Proactive", d: "Anticipation des risques plutôt que réaction." },
              { t: "Impact Mesurable", d: "Accélération des opérations et réduction des risques." },
              { t: "Partenariat Long Terme", d: "Implication dans la pérennité de votre entreprise." }
            ].map((v, i) => (
        ...
        <div className="bg-blue-600 p-12 text-white rounded-2xl flex flex-col justify-center text-center">
          <h3 className="text-2xl font-bold mb-4">Prêt à sécuriser votre stratégie ?</h3>
          <p className="mb-8 text-blue-100">Transformez le cadre réglementaire en terrain d'opportunités.</p>
          <a href="mailto:hello@cocoricolabs.com" className="bg-white text-blue-600 px-8 py-4 rounded-full font-bold hover:bg-slate-100 transition-colors">
            Parler à un expert
          </a>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-start">
          ...
          <div>
            ...
            <p className="text-base md:text-lg text-slate-600 mb-8 md:mb-12 leading-relaxed">
              Nos factures détaillées et notre accompagnement technique vous permettent de justifier vos dépenses innovation auprès de vos partenaires financiers.
            </p>
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="p-6 md:p-8 bg-white border border-slate-200 rounded-xl">
                 ...
                 <p className="text-slate-500 text-sm mb-4">Rembourse 20% des dépenses liées au prototypage.</p>
              ...
              <div className="p-6 md:p-8 bg-white border border-slate-200 rounded-xl">
                 ...
                 <p className="text-slate-500 text-sm mb-4">Rembourse 30% des dépenses de R&D pour résoudre des défis techniques.</p>
                 <div className="h-1 w-full bg-slate-100 rounded-full overflow-hidden">
  ...
  <div className="min-h-screen pt-28 md:pt-32 px-6 md:px-12 bg-white animate-in slide-in-from-bottom-8 duration-700">
    <div className="max-w-[1200px] mx-auto text-center">
       ...
       <h1 className="text-4xl md:text-7xl font-serif font-medium mb-16 leading-tight">
         "Un partenariat qui valorise <br/> vos <span className="italic text-red-600">investissements</span>."
       </h1>
    </div>

    <div className="max-w-[1400px] mx-auto grid md:grid-cols-3 gap-8 mb-32">
       {[
         { icon: BadgeCheck, title: "Livrables Conformes", desc: "Nos rapports techniques et nos factures détaillées sont conçus pour répondre aux exigences des programmes d’accompagnement à l’innovation." },
         { icon: FileText, title: "Spécialistes R&D", desc: "Nous développons des MVPs et solutions Web3 pour des entreprises en phase de R&D, avec une documentation technique conforme." },
         { icon: TrendingUp, title: "Partenaire de Croissance", desc: "Nous accompagnons les startups et PME qui cherchent à structurer leurs dépenses innovation pour en tirer le meilleur parti." },
       ].map((item, i) => (
         <div key={i} className="bg-slate-50 p-8 md:p-12 hover:bg-slate-900 hover:text-white transition-colors duration-500 group rounded-xl">
            <div className="mb-6 text-blue-600 group-hover:text-white transition-colors">
              <item.icon size={48} />
            </div>
            <h3 className="text-2xl font-bold mb-4">{item.title}</h3>
            <p className="text-slate-500 group-hover:text-slate-300 leading-relaxed">{item.desc}</p>
         </div>
       ))}
    </div>
  </div>
...
const FAQ = () => {
  ...
  const faqs = [
    { q: "Quels types de projets accompagnez-vous ?", a: "Nous accompagnons les entreprises dans le développement de sites web sur mesure, MVPs pour valider vos idées, solutions Web3 (smart contracts, dApps, NFTs) et outils internes pour optimiser vos processus R&D." },
    { q: "Pourquoi choisir CocoricoLabs ?", a: "Expertise technique Web3/React, documentation complète (rapports, factures précises) pour faciliter votre gestion, et un accompagnement sur mesure adapté aux startups et PME innovantes." },
    { q: "Comment se déroule la collaboration ?", a: "1. Échange initial sur vos besoins. 2. Proposition détaillée avec devis clair. 3. Développement en étroite collaboration. 4. Livraison avec code source, documentation et support." },
    { q: "Quels livrables recevrai-je ?", a: "Vous recevrez le code source (droits inclus), une documentation technique complète (architecture, guides), des factures détaillées par phase, et un rapport de recette." },
    { q: "Vos factures sont-elles adaptées aux partenaires financiers ?", a: "Oui ! Nos factures respectent les standards comptables français : description précise, ventilation des coûts par phase (conception, dév, tests), et mentions légales obligatoires." },
    { q: "Valorisez-vous nos investissements ?", a: "Absolument. Nous vous aidons à structurer vos dépenses technologiques et à obtenir des livrables techniques répondant aux attentes des institutions (BPI, etc.)." },
    { q: "Proposez-vous des solutions pour la R&D ?", a: "Oui, nous sommes spécialisés dans l'accompagnement R&D : prototypes, solutions innovantes, et rédaction de documentations conformes." },
    { q: "Quels sont vos délais de livraison ?", a: "Site vitrine : 1-3 semaines. MVP : 4-8 semaines. Solution Web3 : 6-9 semaines. Un calendrier précis est fourni à la signature." },
    { q: "Avantage d'une agence française ?", a: "Équipe francophone réactive, livrables conformes aux standards français, et compréhension fine des enjeux de l'innovation en France." }
  ];

  return (
    <div className="min-h-screen pt-28 md:pt-32 px-6 md:px-12 bg-white animate-in slide-in-from-bottom-8 duration-700">
      <div className="max-w-[1000px] mx-auto">
        <h1 className="text-5xl md:text-8xl font-bold mb-16">Vos Questions, <br/><span className="font-serif italic text-blue-600">Notre Expertise</span></h1>
        ...
        <div className="mt-20 p-8 bg-slate-50 rounded-xl text-center">
           ...
           <p className="mb-8 text-slate-500">Contactez-nous directement pour discuter de votre projet.</p>
           <a href="mailto:hello@cocoricolabs.com" className="inline-block px-8 py-3 bg-slate-900 text-white rounded-full font-bold hover:bg-blue-600 transition-colors">hello@cocoricolabs.com</a>
        </div>
      </div>
    </div>
  );
    ...
    <div className="max-w-[1000px] mx-auto text-center">
       ...
       <form className="max-w-xl mx-auto space-y-6 md:space-y-8 text-left">
          ...
          <div className="group">
             ...
             <textarea rows="3" className="w-full bg-transparent border-b border-slate-700 py-3 md:py-4 text-xl md:text-2xl focus:outline-none focus:border-blue-500 transition-colors" placeholder="Objectifs, technologies, délais..." />
          </div>
...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-slate-900 font-sans selection:bg-blue-600 selection:text-white overflow-x-hidden cursor-auto md:cursor-none">
      ...
      {/* --- NAVIGATION --- */}
      <nav className={`fixed top-0 w-full z-50 px-6 md:px-12 flex justify-between items-center transition-all duration-500 
        ${isScrolled && !isMenuOpen ? 'py-4 bg-[#FDFBF7]/95 backdrop-blur-md shadow-sm border-b border-slate-200/50' : 'py-6 md:py-8 bg-transparent'}
        ${isMenuOpen ? 'bg-[#FDFBF7]' : ''}
      `}>
        <div className="flex items-center gap-3 cursor-pointer z-50" onClick={() => setActivePage('home')}>
          <img 
        ...
        <button className="xl:hidden z-50" onClick={() => setIsMenuOpen(!isMenuOpen)}>
