      ...
      <div className="grid lg:grid-cols-2 gap-12 md:gap-20 mb-20 md:mb-32">
        <div>
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-md mb-8 md:mb-12">
            Obtenez un devis détaillé pour votre projet Web3 ou un audit
    ...
    <div className="max-w-[1400px] mx-auto">
      ...
      <div className="mb-24">
        ...
        <h1 className="text-5xl md:text-8xl font-bold mb-12 leading-tight">
          Où la stratégie rencontre <br />{" "}
          <span className="text-blue-600 font-serif italic">le droit</span>.
        </h1>
        <div className="grid md:grid-cols-2 gap-12">
          <p className="text-xl text-slate-600 leading-relaxed font-light border-l-4 border-red-500 pl-6">
            "Chez Cocorico Labs, nous ne vous disons pas seulement ce qui est
            interdit. Nous vous montrons comment le droit peut vous donner un
            avantage décisif."
          </p>
          <div className="space-y-4">
            <p className="text-slate-500">
              Notre approche unique consiste à intégrer l'expertise juridique au
              cœur de la réflexion stratégique. Nous transformons l'adaptation
              réglementaire en avantage concurrentiel et sécurisons votre
              croissance.
            </p>
          </div>
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-32">
        <div className="bg-white p-10 border border-slate-200 hover:border-blue-600 transition-colors duration-300 group">
          <TrendingUp
            size={40}
            className="text-slate-400 mb-6 group-hover:text-blue-600 transition-colors"
          />
          <h3 className="text-2xl font-bold mb-4">
            Stratégies de Croissance (M&A)
          </h3>
          <ul className="space-y-3 text-slate-500 text-sm">
            <li className="flex gap-2">
              <div className="w-1 h-1 bg-red-500 mt-2"></div>Due diligence
              juridique risques & opportunités.
            </li>
            <li className="flex gap-2">
              <div className="w-1 h-1 bg-red-500 mt-2"></div>Structuration
              d'opérations complexes (JV, fusions).
            </li>
            <li className="flex gap-2">
              <div className="w-1 h-1 bg-red-500 mt-2"></div>Négociation de
        ...
        <div className="bg-white p-10 border border-slate-200 hover:border-blue-600 transition-colors duration-300 group">
          ...
          <ul className="space-y-3 text-slate-500 text-sm">
            <li className="flex gap-2">
              <div className="w-1 h-1 bg-red-500 mt-2"></div>Optimisation
              fiscale et holding.
            </li>
            <li className="flex gap-2">
              <div className="w-1 h-1 bg-red-500 mt-2"></div>Audit des chartes
              de gouvernance.
            </li>
            <li className="flex gap-2">
              <div className="w-1 h-1 bg-red-500 mt-2"></div>Protection du
              patrimoine.
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white p-10 border border-slate-200 hover:border-blue-600 transition-colors duration-300 group">
          ...
          <ul className="space-y-3 text-slate-500 text-sm">
            <li className="flex gap-2">
              <div className="w-1 h-1 bg-red-500 mt-2"></div>Droit de la
            ...
            <li className="flex gap-2">
              <div className="w-1 h-1 bg-red-500 mt-2"></div>Sécurisation des
              revenus critiques.
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white p-10 border border-slate-200 hover:border-blue-600 transition-colors duration-300 group">
          ...
          <ul className="space-y-3 text-slate-500 text-sm">
            <li className="flex gap-2">
              <div className="w-1 h-1 bg-red-500 mt-2"></div>Cartographie des
              risques (RGPD, social).
            </li>
            <li className="flex gap-2">
              <div className="w-1 h-1 bg-red-500 mt-2"></div>Programmes de
              conformité sur-mesure.
            </li>
            <li className="flex gap-2">
              <div className="w-1 h-1 bg-red-500 mt-2"></div>Protection de la
              réputation.
            </li>
          </ul>
        </div>
      ...
      <div className="bg-slate-900 text-white p-8 md:p-20 rounded-3xl mb-32">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          {[
            {
              step: "01",
              title: "Diagnostic Intégré",
              text: "Analyse stratégique, opérationnelle ET juridique simultanée.",
            },
            {
              step: "02",
              title: "Langage Business",
              text: "Traduction de la complexité juridique en impact financier clair.",
            },
            {
              step: "03",
              title: "Équipe Intégrée",
              text: "Avocats, stratèges et financiers travaillant main dans la main.",
            },
            {
              step: "04",
              title: "Livrables Ops",
              text: "Pas de mémos théoriques. Des plans d'actions et roadmaps.",
            },
          ].map((m, i) => (
            <div key={i} className="relative pt-8 border-t border-white/20">
              ...
              <div className="text-4xl font-serif italic text-blue-500 mb-4">
                {m.step}
              </div>
      ...
      <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
        <div>
          ...
          <div className="space-y-6">
            {[
              {
                t: "Vision Holistique",
                d: "Connexion entre droit, finance et stratégie.",
              },
              {
                t: "Approche Proactive",
                d: "Anticipation des risques plutôt que réaction.",
              },
              {
                t: "Impact Mesurable",
                d: "Accélération des opérations et réduction des risques.",
              },
              {
                t: "Partenariat Long Terme",
                d: "Implication dans la pérennité de votre entreprise.",
              },
            ].map((v, i) => (
        ...
        <div className="bg-blue-600 p-12 text-white rounded-2xl flex flex-col justify-center text-center">
          <h3 className="text-2xl font-bold mb-4">
            Prêt à sécuriser votre stratégie ?
          </h3>
          <p className="mb-8 text-blue-100">
            Transformez le cadre réglementaire en terrain d'opportunités.
          </p>
          <a
            href="mailto:hello@cocoricolabs.com"
            className="bg-white text-blue-600 px-8 py-4 rounded-full font-bold hover:bg-slate-100 transition-colors"
          >
            Parler à un expert
          </a>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-slate-900 font-sans selection:bg-blue-600 selection:text-white overflow-x-hidden cursor-auto md:cursor-none">
      ...
      <nav
        ...
        ${
          isScrolled && !isMenuOpen
            ? "py-4 bg-[#FDFBF7]/95 backdrop-blur-md shadow-sm border-b border-slate-200/50"
      ...
      >
        ...
        {isMenuOpen && (
          <div className="fixed inset-0 bg-[#FDFBF7] flex flex-col items-center justify-center gap-6 md:gap-8 z-40">
            <button
              onClick={() => setActivePage("home")}
